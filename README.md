# AI Web Chatbot for Personalized Conversations- Project Description

## Overview
AI Web Chatbot for Personalized Conversations (nivonix-ai-chatbot) is a full-stack web application that provides an intelligent chatbot interface powered by Google's Gemini API. Users can have persistent conversations, manage multiple chat threads, and access their chat history across sessions.

#### Live Link : https://nivonix-ai-chatbot.vercel.app/
#### Backend Link : https://nivonix-ai-chatbot-1.onrender.com
...
```
AI Web Chatbot for Personalized Conversations/
├── Frontend/
│   ├── src/
